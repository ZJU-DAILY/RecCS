...
class TransformerModel(nn.Module):
    def __init__(self, hops, n_class, input_dim, pe_dim, n_layers=6, num_heads=8, hidden_dim=64, ffn_dim=64, dropout_rate=0.0, attention_dropout_rate=0.1):
        super().__init__()
    ...
    def forward(self, batched_data):
        batched_data = F.normalize(batched_data)
